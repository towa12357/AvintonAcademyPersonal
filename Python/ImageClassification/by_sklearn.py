...
def second_classification():
    ...
    path_to_poorly_classified_label = "./sk-result/label"+str(poorly_classified_label_number)+"/"
...
def final_classification():
    poorly_classified_label_number = 0 
    poorly_classified_label_number2 = 1
    path_to_poorly_classified_label = "./sk-result/label"+str(poorly_classified_label_number)+"/label"+str(poorly_classified_label_number2)+"/"
